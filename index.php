        ...
        <div class="ordinary-slider header-menu__content" data-abs-curtain="false">
            <div class="swiper header-menu__slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide header-menu__slide">
                        <picture>
                            <source srcset="./img/card-imglg.webp, ./img/card-imglg@2x.webp 2x" type="image/webp" media="(min-width: 1401px)"/>
                            <source srcset="./img/card-imglg.jpg, ./img/card-imglg@2x.jpg 2x" type="image/jpg" media="(min-width: 1401px)"/>
                            <source srcset="./img/card-img.webp, ./img/card-img@2x.webp 2x" type="image/webp" media="(max-width: 1401px)"/>
                            <source srcset="./img/card-img.jpg, ./img/card-img@2x.jpg 2x" type="image/jpg" media="(max-width: 1401px)"/>
                            <img src="./img/card-img.jpg" alt="" />
                        </picture>
                    </div>
                    <div class="swiper-slide header-menu__slide">
                        <picture>
                            <source srcset="./img/card-img-2lg.webp, ./img/card-img-2lg@2x.webp 2x" type="image/webp" media="(min-width: 1401px)"/>
                            <source srcset="./img/card-img-2lg.jpg, ./img/card-img-2lg@2x.jpg 2x" type="image/jpg" media="(min-width: 1401px)"/>
                            <source srcset="./img/card-img-2.webp, ./img/card-img-2@2x.webp 2x" type="image/webp" media="(max-width: 1401px)"/>
                            <source srcset="./img/card-img-2.jpg, ./img/card-img-2@2x.jpg 2x" type="image/jpg" media="(max-width: 1401px)"/>
            ...
            <div class="header-menu__right">
                <nav class="header-menu__nav">
                    <ul class="header-menu__links">
                        ...
                        <li class="header-menu__link" data-slide-index="6">
                            <a href="#cocktail-card">Cocktail card</a>
                        </li>
                ...
                <div class="header-menu__bottom">
                    <button class="btn header-menu__btn" data-trigger-modal="bronir">
                    ...
                    <div class="header-menu__btns">
                        <button class="btn btn--circled header-menu__circled-btn">
        ...
        <div class="swiper-wrapper">
            ...
            <section class="swiper-slide section section--wrapper section--fullscreen fullimage-section double-strip" data-scroll-target="id1" data-section="2" data-sub-section="0" style="--bg: #293630">
                <div class="section__container fullimage-section__mob-wrapper" data-mobile-anchor="conception">
                    <div class="fullimage-section__bg">
                        <picture>
                            <source srcset="./img/concept-bglg.webp, ./img/concept-bglg@2x.webp 2x" type="image/webp" media="(min-width: 1401px)"/>
                            <source srcset="./img/concept-bglg.jpg, ./img/concept-bglg@2x.jpg 2x" type="image/jpg" media="(min-width: 1401px)"/>
                            <source srcset="./img/concept-bg.webp, ./img/concept-bg@2x.webp 2x" type="image/webp" media="(max-width: 1401px)"/>
                            <source srcset="./img/concept-bg.jpg, ./img/concept-bg@2x.jpg 2x" type="image/jpg" media="(max-width: 1401px)"/>
                        ...
                        <div class="partial-section__side">
                            <div class="partial-section__side-top">
                                <h3 class="title title--md partial-section__title" data-text-anima="true" data-text-column="true">
                                    ...
                                    <span class="row">
                                        <span class="outer"><span>Cocktail Club Place</span></span>
                                    </span>
                                </h3>
                            </div>
                            <div class="partial-section__side-bottom end">
                                <p class="text partial-section__text" data-text-anima="true" data-reset-mob="true" data-text-column="true">
                                    <span class="row">
                                        <span class="outer"><span>Уникальное место, где в чарующей атмосфере сочетаются </span></span>
                                    </span>
                                    <span class="row">
                                        <span class="outer"><span>высокий уровень сервиса, изысканные коктейли и яркие </span></span>
                                    </span>
                                    <span class="row">
                    ...
                    <div class="modal-section__window">
                        ...
                        <div class="modal-section__content">
                            ...
                            <h4 class="modal-section__title" data-text-anima="true" data-reset-mob="true" data-text-column="true">
                                <span class="row">
                                    <span class="outer"><span>Как бармен, я стараюсь создавать не только</span></span>
                                </span>
                                <span class="row">
                                    <span class="outer"><span>коктейли, но и волшебные вечера, где каждый</span></span>
                                </span>
                                <span class="row">
                                    <span class="outer"><span>глоток становится приключением, а каждый</span></span>
                                </span>
                                <span class="row">
            ...
            <section class="swiper-slide section section--wrapper section--fullscreen fullimage-section double-strip" data-section="3" data-sub-section="0" style="--bg: #DCC5B7">
                <div class="section__container fullimage-section__mob-wrapper" data-mobile-anchor="afisha">
                    <div class="fullimage-section__bg">
                        <picture>
                            <source srcset="./img/afisha-bg-lg.webp, ./img/afisha-bg-lg@2x.webp 2x" type="image/webp" media="(min-width: 1401px)"/>
                            <source srcset="./img/afisha-bg-lg.jpg, ./img/afisha-bg-lg@2x.jpg 2x" type="image/jpg" media="(min-width: 1401px)"/>
                            <source srcset="./img/afisha-mob.webp" type="image/webp" media="(max-width: 575px)"/>
                            <source srcset="./img/afisha-mob.jpg" type="image/jpg" media="(max-width: 575px)"/>
                            <source srcset="./img/afisha-bg.webp, ./img/afisha-bg@2x.webp 2x" type="image/webp" media="(max-width: 1401px)"/>
                            <source srcset="./img/afisha-bg.jpg, ./img/afisha-bg@2x.jpg 2x" type="image/jpg" media="(max-width: 1401px)"/>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide partial-section__placeholder-mob-slide">
                                        <div class="partial-section__placeholder-text">
                                            ...
                                            <dl class="components__list">
                                                <div class="components__list-item">
                                                    <dt>Адрес:</dt>
                                                    <dd>г. Сочи, ул. Войковская, д.3</dd>
                                                </div>
                                                <div class="components__list-item">
                                                    <dt>To reserve:</dt>
                                                    <dd>
                                        ...
                                        <picture class="partial-section__placeholder-mob-image">
                                            <source srcset="./img/partial-slide.webp, ./img/partial-slide@2x.webp 2x" type="image/webp"/>
                                            <source srcset="./img/partial-slide.jpg, ./img/partial-slide@2x.jpg 2x" type="image/jpg"/>
                                            <img src="./img/partial-slide.jpg" alt="" />
                                        </picture>
                                    </div>
                                    <div class="swiper-slide partial-section__placeholder-mob-slide">
                                        <div class="partial-section__placeholder-text">
            ...
            <section class="swiper-slide section section--wrapper section--fullscreen fullimage-section" data-section="4" data-sub-section="0" style="--bg: #DCC5B7">
                <div class="section__container fullimage-section__mob-wrapper" data-mobile-anchor="cocktail-card">
                    <div class="fullimage-section__bg">
                        <picture>
                            <source srcset="./img/cocktail-bg.webp, ./img/cocktail-bg@2x.webp 2x" type="image/webp" media="(min-width: 575px)"/>
                            <source srcset="./img/cocktail-bg.jpg, ./img/cocktail-bg@2x.jpg 2x" type="image/jpg" media="(min-width: 575px)"/>
                            <source srcset="./img/cocktail-mob.webp" type="image/webp" media="(max-width: 575px)"/>
                            <source srcset="./img/cocktail-mob.jpg" type="image/jpg" media="(max-width: 575px)"/>
                            <img src="./img/cocktail-bg.jpg" alt="" />
                        </picture>
                    </div>
                    <div class="section__emerging-bg"></div>
                    <div class="fullimage-section__bottom">
                    ...
                    <div class="section__container">
                        <div class="partial-section__side">
                            ...
                            <div class="partial-section__side-bottom">
                                ...
                                <button class="btn partial-section__btn" data-trigger-modal="menu-1">
                            ...
                            <div class="modal-section__window-wrapper">
                                ...
                                <div class="modal-section__content">
                                    <div class="modal-section__img modal-section__call-modal" data-trigger-modal="menu-1">
                                        <picture>
                                            <source srcset="./img/cocktail-modal-img.webp, ./img/cocktail-modal-img@2x.webp 2x" type="image/webp"/>
                                            <source srcset="./img/cocktail-modal-img.jpg, ./img/cocktail-modal-img@2x.jpg 2x" type="image/jpg"/>
                                            <img src="./img/cocktail-modal-img.jpg" alt="" />
                                        </picture>
                    ...
                    <div class="section__container">
                        <div class="partial-section__side">
                            ...
                            <div class="partial-section__side-bottom">
                                ...
                                <button class="btn partial-section__btn" data-trigger-modal="menu-2">
                                    <span>Меню</span>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="modal-section__window-wrapper">
                                ...
                                <div class="modal-section__content">
                                    <div class="modal-section__img modal-section__call-modal" data-trigger-modal="menu-2">
                                        <picture>
                                            <source srcset="./img/modal-img-2.webp, ./img/modal-img-2@2x.webp 2x" type="image/webp"/>
                                            <source srcset="./img/modal-img-2.jpg, ./img/modal-img-2@2x.jpg 2x" type="image/jpg"/>
                                            <img src="./img/modal-img-2.jpg" alt="" />
                                        </picture>
                                        <button class="btn--reset modal-section__btn">
                                            <svg width="22" height="22">
                                               <use xlink:href="img/sprite.svg#plus"></use>
    ...
    <div class="footer__wrapper">
        <div class="footer__side">
            <div class="footer__top">
                <h2 class="title footer__title">Contacts</h2>
            ...
            <div class="ordinary-slider modal__text-wrapper">
                <div class="swiper modal__text-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">lONG ISLAND 2</h2>
                            <p class="text modal__text">
                                Это американский классический коктейль, который обладает репутацией одного из самых крепких и опасных напитков. Его история полна загадок и различных версий, которые придают этому коктейлю особый шарм. Среди множества коктейлей, есть у меня определенный лидер, мне очень нравится его необычный и очень освежающий вкус
                            </p>
                        </div>
                        ...
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">lONG ISLAND 6</h2>
                            <p class="text modal__text">
                                Это американский классический коктейль, который обладает репутацией одного из самых крепких и опасных напитков. Его история полна загадок и различных версий, которые придают этому коктейлю особый шарм. Среди множества коктейлей, есть у меня определенный лидер, мне очень нравится его необычный и очень освежающий вкус
                            </p>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide modal__mob-slide">
                            ...
                            <div class="modal__mob-slide-img">
                                <picture>
                                    <source srcset="./img/menu-1.webp, ./img/menu-1@2x.webp 2x" type="image/webp"/>
                                    <source srcset="./img/menu-1.jpg, ./img/menu-1@2x.jpg 2x" type="image/jpg"/>
                        ...
                        <div class="swiper-slide modal__mob-slide">
                            ...
                            <div class="modal__mob-slide-img">
                                <picture>
                                    <source srcset="./img/menu-2.webp, ./img/menu-2@2x.webp 2x" type="image/webp"/>
                                    <source srcset="./img/menu-2.jpg, ./img/menu-2@2x.jpg 2x" type="image/jpg"/>
                                    <img src="./img/menu-1.jpg" alt="" />
                                </picture>
                            </div>
                        </div>
        ...
        <div class="modal__content" >
            <div class="ordinary-slider modal__text-wrapper">
                <div class="swiper modal__text-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">MARBLED BEEF <br> STREK</h2>
                            <p class="text modal__text">
                        ...
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">MARBLED BEEF <br> STREK 2</h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                        </div>
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">MARBLED BEEF <br> STREK 3</h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                        </div>
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">MARBLED BEEF <br> STREK 4</h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                        </div>
                        <div class="swiper-slide modal__side-inner">
                            <h2 class="title title--md modal__title">MARBLED BEEF <br> STREK 5</h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                        </div>
            ...
            <div class="ordinary-slider modal__mob-slider">
                <div class="swiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide modal__mob-slide">
                            <h2 class="title title--md modal__title">MARBLED BEEF</h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                            <div class="modal__mob-slide-img">
                        ...
                        <div class="swiper-slide modal__mob-slide">
                            <h2 class="title title--md modal__title">MARBLED </h2>
                            <p class="text modal__text">
                                Позвольте себе испытать непревзойденное удовольствие и насладиться истинным шедевром кулинарии - стейком из мраморной говядины, который оставит в вашей памяти незабываемые впечатления и наслаждение от первого до последнего прожорливого кусочка
                            </p>
                            <div class="modal__mob-slide-img">
